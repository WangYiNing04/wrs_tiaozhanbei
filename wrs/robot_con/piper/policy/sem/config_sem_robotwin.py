...
config = dict(
    ...
    num_workers=8,
    lr=1e-4,
    checkpoint="/home/wyn/PycharmProjects/wrs_tiaozhanbei/wrs/robot_con/piper/policy/sem/ckpt/groundingdino_swint_ogc_mmdet-822d7e9d-rename.pth",
    bert_checkpoint="/home/wyn/PycharmProjects/wrs_tiaozhanbei/wrs/robot_con/piper/policy/sem/ckpt/bert-base-uncased",
    data_path="",
    urdf="/home/wyn/PycharmProjects/wrs_tiaozhanbei/wrs/robot_con/piper/policy/sem/urdf/piper_description_dualarm.urdf",
    multi_task=True,
    task_names=["stack_blocks_three"],
)
