...
config = dict(
    ...
    num_workers=8,
    lr=1e-4,
    checkpoint="/home/fafurobot/RoboOrchardLab-master/projects/sem/robotwin/ckpt/groundingdino_swint_ogc_mmdet-822d7e9d-rename.pth",
    bert_checkpoint="/home/fafurobot/RoboOrchardLab-master/projects/sem/robotwin/ckpt/bert-base-uncased",
    data_path="/home/fafurobot/RoboOrchardLab-master/projects/sem/robotwin/data/lmdb",
    urdf="/home/fafurobot/RoboOrchardLab-master/projects/sem/robotwin/urdf/piper_description_dualarm.urdf",
    multi_task=True,
        ...
        cfg=BIP3DConfig(
            ...
            decoder=dict(
                ...
                ffn=dict(
                    ...
                    embed_dims=embed_dims,
                    feedforward_channels=2048,
                    act_cfg=dict(type=nn.SiLU, inplace=False),
                ),
                head=dict(
                    type=UpsampleHead,
                    ...
                    act=dict(type=nn.SiLU, inplace=False),
                    norm_act_idx=[0, 1, 2],
                ),
