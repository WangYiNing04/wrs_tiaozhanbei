    ...
    def __init__(self,
        ...
        try:
            if platform.system() == "Windows":
                ...
                raise OSError("Only Windows and Linux systems are supported")
            self.__arm_can=C_STD_CAN(can_name, bus_type, 1000000, judge_flag, can_auto_init, self.ParseCANFrame)
